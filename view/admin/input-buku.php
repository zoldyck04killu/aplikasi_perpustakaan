...
<div class="form">
    <form>
      <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input class="form-control" type="text" placeholder="Kode Buku">
        </div>
      </div>
      <div class="form-group row">
        <label for="staticEmail" class="col-sm-2 col-form-label">Buku</label>
        <div class="col-sm-10">
            <input class="form-control" type="text" placeholder="Buku">
        </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input class="form-control" type="text" placeholder="Jumlah Buku">
        </div>
      </div>
      <div class="form-group row">
        <label for="staticEmail" class="col-sm-2 col-form-label">Klasifikasi</label>
        <div class="col-sm-10">
            <input class="form-control" type="text" placeholder="Klasifikasi">
        </div>
      </div>
